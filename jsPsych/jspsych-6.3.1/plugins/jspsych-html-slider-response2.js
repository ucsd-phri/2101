...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var half_thumb_width = 850; //need to futz with this to make it fit

    // var html = '<div id="jspsych-html-slider-response-stimulus">' + trial.stimulus + '</div><br>';

    // html += '<div><input type="range" class="jspsych-slider" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" value="'+trial.slider_start+' id="jspsych-html-slider-response-response""/></div>';
    ...
    // }
    // html += '">';
    html += '<div><input type="range" class="jspsych-slider" value="'+trial.slider_start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" id="jspsych-html-slider-response-response"></input>';
    html += '<div>'
