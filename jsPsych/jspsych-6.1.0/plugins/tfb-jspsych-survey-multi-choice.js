...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ...
      ".multi-choice-response-wrapper { text-align:center; font-size: 14pt }"+ /* ADDED BY TIM */
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '</p><div class="multi-choice-response-wrapper">'; /* DIV ADDED BY TIM */
      ...
      for (var j = 0; j < question.options.length; j++) {
        ...
        html += '&nbsp; <input type="radio" name="'+input_name+'" id="'+input_id+'" value="'+question.values[j]+'" '+required_attr+'></input>';
        html += '</div>';
      }

      html += '</div></div>';/* END DIV ADDED BY TIM */
    }
