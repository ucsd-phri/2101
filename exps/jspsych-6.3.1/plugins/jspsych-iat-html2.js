 ...
 jsPsych.plugins['iat-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var after_response = function(info) {
      ...
      if (response.rt !== null && jsPsych.pluginAPI.compareKeys(response.key, rightKeyCode || leftKeyCode)) {
        if (trial.response_ends_trial) {
          end_trial();
        };
      } else if (response.rt !== null && jsPsych.pluginAPI.compareKeys(response.key, leftKeyCode)) {
        if (trial.response_ends_trial) {
          end_trial();
        };
      };
