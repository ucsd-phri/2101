...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //   ".jspsych-survey-multi-choice-option { line-height: 2; text-align: center; margin-right: auto; margin-left: auto;}"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}"+
    //   ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {display: inline-block;  margin-left: auto;  margin-right: auto;  vertical-align: top; text-align: center;}"+
    //   "label.jspsych-survey-multi-choice-text input[type='radio'] {margin-right: 1em;}";
      "label.jspsych-survey-multi-choice-text input[type='radio'] {margin-right: 1em; text-align: center;}"
    html += '</style>';
// 
    // show preamble text
